...
All workflows and templates in this repository have been created, collected and tested by the author and work perfectly in the author’s environment. They are provided as templates for general use. While they work fine for the author, any errors or issues that occur while using them are not the responsibility of the author. This disclaimer applies to all workflows in this repository.
